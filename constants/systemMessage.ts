...
1. youtube_transcript:
  - Query: { transcript(videolr1: $videolr1, langCode: $langCode) { title captions { text start dir } }}
...
2. google_books:
  ...
  refer to previous messages for context and use then to accurately answer the question
`;
